...
@section('content')
    <div class="container">
        <h4 class="text-center pt-4">Edit Post</h4>
        <div class="row">
            ...
            <form enctype="multipart/form-data" method="POST" action="{{ route('admin.post.update', $post->id) }}">
                ...
                <x-input-field field="subject" type="text" :value="$post->subject"></x-input-field>
                ...
                <x-input-field field="hashtags" type="text" :value="$post->hashtags
                    ->map(function ($tag) {
                        return '#' . $tag->name;
                    })
...
@section('foot')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            let url = `http://127.0.0.1:8000/admin/upload/image`;
            if (locale == 'vi') {
                url = `http://127.0.0.1:8000/${locale}/admin/upload/image`;
            }
