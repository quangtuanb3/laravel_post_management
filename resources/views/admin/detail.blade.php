...
@section('content')
    <div class="container">
        ...
        <div class="d-flex" style="position: absolute; right:50px; top:5em">
            <a class="btn btn-primary m-2" href="{{ route('admin.post.edit', $post->id) }}"><i class="fa fa-edit"></i></a>
            <form id="delete-post-form-{{ $post->id }}" action="{{ route('admin.post.destroy', $post->id) }}"
                method="post">
                @csrf
                @method('delete')
